...
{
  /// <summary>
  ///   Initializes a new instance of <see cref="BundleConfig" />
  /// </summary>
  /// <param name="mainAssemblyPath">The full file path to the main assembly for the plugin.</param>
  public BundleConfig(string mainAssemblyPath)
  {
  ...
  /// <summary>
  ///   If set, replaces the default <see cref="AssemblyLoadContext" /> used by the <see cref="BundleLoader" />.
  ...
  ///   Use the event <see cref="BundleLoader.Reloaded" /> to be notified of changes.
  /// </summary>
  /// <remarks>
